...
// Import the Vim keybind data from a local file
import { vimKeybindData } from "./data_vim.js"; // Assuming this file exports an object or array
...
export default () => {
    const numOfTabs = Math.ceil(vimKeybindData.length / KEYBIND_SECTIONS_PER_PAGE);
